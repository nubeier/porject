...
//进行分页
	$sql2="select shop.*,brand.name bname,class.name cname from brand,class,shop where brand.class_id=class.id and shop.brand_id=brand.id and brand_id={$brand_id} limit ".($page-1)*$page_size.",$page_size";
	mysql_query("set names utf8");
